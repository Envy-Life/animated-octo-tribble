import { 
  ...
  export const userWallets = pgTable(
    'user_wallets',
    {
      ...
      userId: numeric('user_id').notNull().references(() => users.userId),
  ...
  export const bridges = pgTable(
    'bridges',
    {
      ...
      userId: numeric('user_id').notNull().references(() => users.userId),
      sourceChainId: varchar('source_chain_id', { length: 50 }).notNull().references(() => chains.chainId),
      destinationChainId: varchar('destination_chain_id', { length: 50 }).notNull().references(() => chains.chainId),
